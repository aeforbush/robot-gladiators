...
var fightOrSkip = function() {
    ...
    if (promptFight === "" || promptFight === "null") {
        ...
        // use a return to call it again and stop the rest of this function from running
        return fightOrSkip();
    }
    ...
    if (promptFight === "skip") {
        // confirm player wants to skip
         var confirmSkip = confirm("Are you sure you'd like to quite?");
   ...
   playerInfo.reset();
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            // pass the pickedenemy.name variable's value into the fight function, where it will asssume the value of the enemy.name parameter
